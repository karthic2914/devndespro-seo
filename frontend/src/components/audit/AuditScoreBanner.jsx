...
export default function AuditScoreBanner({ auditData, categories, isScreenshot = false, aiScores = {}, cronEnabled = false, onCronToggle = () => {}, onCategoryClick = () => {}, compact = false }) {
  ...
  if (compact) {
    const aiCategories = categories.filter(c => c.name === 'AI Snippet' || c.name === 'AEO')
    return (
